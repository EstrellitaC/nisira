    ...
    <div class="inicio">
        ...
        <div class="cards">
            ...
            <div class="card card2">
                <img src="@/assets/descanso2.jpg" alt="">
                <h1>DESCANSOS</h1>
                <p>Aquí encontraras las fechas de descanso del soporte</p>
                <button class="ingresar2"><a href="/descanso">Ingresar</a></button>
            </div>
        </div>
    </div>
</template>
...
.cards .card1 .ingresar1 a{
    text-decoration: none;
    color: #ffffff;
}
.cards .card2 .ingresar2 a{
    text-decoration: none;
    color: #ffffff;
}
</style>