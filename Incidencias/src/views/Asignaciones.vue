<template>
    <div class="inicio">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Asignaciones Faltantes</h1>
        ...
        <div class="main">
            ...
            <div class="botones">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="openModal">Asignaciones faltantes</button>
                <button><a href="/clientes">Asignar</a></button>
            </div>
        </div>
