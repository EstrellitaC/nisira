<template>
      ...
      <div class="header">
        <div class="nav-inner">
          <div class="logo">
            <img alt="" />
            <a
              style="width: 4%; height: 100%; position: absolute"
              href="/home"
            ></a>
            <h2>Nisira</h2>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      async buscarnombre() {
        this.vips = this.vips.filter((vip) => vip.nombre == this.buscar);
          console.log("no da", this.vips);
          // console.log("Mensaje", this.buscar)
          // const data = await axios.get(`http://localhost:8089/api/v1/vacaciones`,{params:{nombre:this.buscar}})
          // this.vips = data.data
          // console.log (this.vips)
          // console.log (data)
        }
